    ...
    <div className="user-table">
      ...
      {data.map(res => (
        <div className="table-row" key={res.id}>
          ...
          <div className="table-cell">{res.cena + res.exitDate?calculateAdditionalCost(res.countdown, res.exitDate, Math.floor(calculateTimeDifference(res.entryDate, res.exitDate))):0}</div>
